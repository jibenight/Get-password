...
export function generateMemorablePassword(options) {
  ...
  switch (phraseType) {
    case 'simple': // Le [adjectif] [nom] [verbe]
      ...
      const adjective = agreeAdjective(
        getRandomElement(adjectivesList.adjectives),
        noun
      );
    ...
    case 'descriptive': // Le [nom] [adjectif] [verbe] [adverbe]
      ...
      const adjective2 = agreeAdjective(
        getRandomElement(adjectivesList.adjectives),
        noun2
      );
      ...
      phrase =
        `Le${
          noun2.toLowerCase().startsWith('a') ||
          noun2.toLowerCase().startsWith('e') ||
          noun2.toLowerCase().startsWith('i') ||
          noun2.toLowerCase().startsWith('o') ||
          noun2.toLowerCase().startsWith('u') ||
          noun2.toLowerCase().startsWith('y')
            ? "'"
            : ' '
...
export function initMemorablePasswordGenerator() {
  console.log(
    "Début de l'initialisation du générateur de mots de passe mémorable"
  );
  ...
  console.log(
    "Fin de l'initialisation du générateur de mots de passe mémorable"
  );
}
